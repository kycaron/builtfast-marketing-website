...
<template>
  <div class="lg:min-h-screen w-full bg-black text-white font-inter relative overflow-hidden">
    ...
    <div class="relative min-h-[650px] lg:h-screen flex items-center justify-center px-4 sm:px-8">
      <!-- Text & CTA -->
      <div
        class="absolute px-4 space-y-14 lg:space-y-8 w-[90%] sm:w-[765px] top-[200px] sm:top-[250px] left-1/2 transform -translate-x-1/2 sm:left-[200px] sm:translate-x-0 z-10 text-left"
      >
        <HeroHeader
          class="space-y-6 !px-0"
          title="Web Hosting Built for Speed & Service."
          highlight="Speed"
          highlightColor="cyan"
      ...
      <!-- Background Image -->
      <div
        class="absolute bg-[url('/assets/images/hero_one_gradient.png')] bg-no-repeat bg-contain sm:bg-auto w-full h-full sm:w-[1400px] sm:h-[933px] sm:top-0 sm:left-[541px]"
      >
      </div>
    </div>
  </div>
